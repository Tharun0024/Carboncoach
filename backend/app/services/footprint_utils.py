...
def calculate_transport(data: Dict[str, Any], factors: Dict) -> float:
    ...
    if flights > 0:
        ...
        total += (short_flights * 1000 * (short_flight_factor or flight_factor)) / 12
        total += (long_flights * 5000 * (long_flight_factor or flight_factor)) / 12
